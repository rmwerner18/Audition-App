...
10.times do 
    CastingAgent.create!(name: Faker::Name.name, agency: Faker::Company.name, email: Faker::Internet.unique.email(name: Faker::Name.name, domain: 'example'), username: Faker::Internet.unique.username, password: 'audition', password_confirmation: 'audition', pic: Faker::LoremPixel.image(size: "50x60", is_gray: false, category: 'people'))
end
...
10.times do
    Event.create!(title: Faker::Theatre::Musicals.unique.title, date: Faker::Date.forward(days: 23), location: ['Pearl Studios', 'Ripley Grier', 'Shetler Studios', 'Chelsea Studios', '42nd Street Studios'].sample, casting_agent_id: CastingAgent.all.ids.sample, production_type: "Musical", pic: Faker::LoremPixel.image(size: "50x60", is_gray: false, category: 'people'))
end
